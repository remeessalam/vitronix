...
const WhyChooseUs = () => {
  ...
  return (
    <section className="py-[5rem] bg-gradient-to-r from-primarygradient/30 to-primary/30">
      <div className="wrapper text-center text-white flex flex-col gap-7">
            ...
            <div className="flex flex-col gap-5 h-full">
              ...
              >
                <div className="flex w-full text-start items-center justify-between gap-3">
                  <h5 className="text-xl">Proven Expertise</h5>
                  <img
                ...
                <p className="desc text-white/80 text-start mt-3">
                  We bring years of experience and deep technical knowledge to
                  deliver top-notch IT solutions that meet your needs.
                </p>
              </div>
              <div
                data-aos="fade-right"
              ...
              >
                ...
                <p className="desc text-white/80 text-start mt-3">
                  Your goals are our priority. We focus on understanding your
                  unique challenges to craft tailored solutions for success.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-5 h-full">
              ...
              >
                ...
                <p className="desc text-white/80 text-start mt-3">
                  ...
                  technology that drives growth and competitive advantage.
                </p>
              </div>
              <div
                data-aos="fade-left"
              ...
              >
                <div className="flex w-full text-start items-center justify-between gap-3">
                  <h5 className="text-xl">Commitment to Quality</h5>
                  <img
                ...
                <p className="desc text-white/80 text-start mt-3">
                  We ensure every project is executed with attention to detail,
                  providing reliable, high-quality results that exceed
                  expectations.
                </p>
              </div>
            </div>
        ...
        <div className="pt-[3rem]">
          <div
            ref={ref}
            data-aos="fade-up"
            className="w-full grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-10 lg:gap-5 rounded-3xl bg-gradient-to-r from-primarygradient to-primary p-[2rem]"
          >
