...
const Thankyou = () => {
  return (
    <div className="min-h-screen flex flex-col justify-between bg-primary">
      <div className="py-4 top-0 w-full bg-black/60 backdrop-blur-md z-50 text-black">
      ...
      <div className="wrapper h-full flex flex-col items-center py-[8rem] gap-3 text-white text-center">
        ...
        <Link to="/" className="secondary-btn w-fit mt-4 text-black">
          Home
        </Link>
      </div>
        ...
        <div className="wrapper text-white">
          <div className="flex md:flex-row flex-col justify-between gap-10">
            <div className="flex flex-col items-center">
              <img src={logoImg} className="h-[9rem] md:h-[9rem]" alt="" />
